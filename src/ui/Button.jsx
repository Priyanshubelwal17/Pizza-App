...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    round:
      'inline-block bg-stone-200 w-8 h-8 text-sm font-bold text-stone-800  rounded-full hover:bg-stone-300 transition-colors duration-300 flex items-center justify-center focus:ring focus:ring-stone-300 focus:ring-offset-2',
    secondary:
